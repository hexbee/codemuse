...
export const debugAI = {
    ...
    checkStorage: () => {
        ...
        console.log('AI Config:', aiConfig ? JSON.parse(aiConfig) : 'Not found');
        console.log('Conversations:', conversations ? JSON.parse(conversations).length + ' conversations' : 'Not found');
    ...
    exportDebugData: () => {
        const debugData = {
            ...
            currentConversationId: localStorage.getItem('current-conversation-id'),
